      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-6 flex items-center justify-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground leading-tight">Multi-Cloud Storage Aggregator</span>
          </div>
        </div>
        ...
        <Card className="ios-card shadow-xl">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>
              Buat akun untuk mulai mengelola file Google Drive Anda.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Password di-hash dengan bcrypt (12 salt rounds) — tidak disimpan plaintext.
                </p>
              </div>

              {error && (
                <div className="flex items-start gap-2 rounded-xl border border-rose-200 bg-rose-50 p-3 text-sm text-rose-700 dark:border-rose-900 dark:bg-rose-950/30 dark:text-rose-200">
